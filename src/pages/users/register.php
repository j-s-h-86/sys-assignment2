...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $customer->PersonalNumber = $_POST['PersonalNumber'];
    ...
    $v->field(`PersonalNumber`)->required()->numeric()->min_len(10)->max_len(10);
    ...
    <form method="post" class="form">
        <table width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <th><label for="name">Personnummer</label></th>
                    <td>
                        <input class="form-control" type="text" name="PersonalNumber"
                            value="<?php echo $customer->PersonalNumber ?>">
